...
public:
    ...
    enum {
        ...
        k_param_drone_height_off, // gabe
        k_param_final_land_alt, // gabe
    ...
    AP_Int32        final_land_alt;              // Height above ground we want drone to transition to final landing speed
